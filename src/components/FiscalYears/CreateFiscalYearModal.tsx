...
interface CreateFiscalYearModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: (fiscalYear: Omit<FiscalYear, 'id' | 'createdAt' | 'budgetVersion'>) => void;
}

export function CreateFiscalYearModal({ isOpen, onClose, onSave }: CreateFiscalYearModalProps) {
      ...
      <div className="bg-white rounded-xl p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-3">
            ...
            <h2 className="text-xl font-semibold text-gray-800">Novo Exercício Orçamentário</h2>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              placeholder="Descrição opcional do exercício orçamentário"
            />
          </div>
