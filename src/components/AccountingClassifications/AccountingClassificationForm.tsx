...
interface AccountingClassificationFormProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: (data: AccountingClassificationFormData) => void | Promise<void>;
  onDelete?: (id: string) => Promise<void>; // ← vem do pai (Opção B)
...
export function AccountingClassificationForm({
  ...
  const handleDelete = async () => {
    ...
    try {
      setIsSubmitting(true);
      // ajuste o tipo do id se necessário
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                placeholder="Ex: Receitas Operacionais, Custo Fixo..."
                disabled={isSubmitting}
              />
